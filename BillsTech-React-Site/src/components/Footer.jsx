    ...
    <footer className="mt-32 bg-[#252641]">
		<div className="max-w-lg mx-auto">
			<div className="flex py-12 justify-center text-white items-center px-20 sm:px-36">
				...
				<span className="border-l border-gray-500 text-sm pl-5 py-2 font-semibold">Virtual className for Zoom</span>
			</div>
			<div className="text-center pb-16 pt-5">
				...
				<div className="px-5 sm:px-0 flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 justify-center mt-3">
					...
					<button type="submit" className="text-white w-40 sm:w-auto mx-auto sm:mx-0 font-semibold px-5 py-2 rounded-full bg-yellow-500">Subscribe</button>
				</div>
			</div>
			...
			<div className="text-center text-white">
				<p className="my-3 text-gray-400 text-sm">&copy; 2021 className Technologies Inc. </p>
