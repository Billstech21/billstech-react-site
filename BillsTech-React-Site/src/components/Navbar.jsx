	...
	<div className="w-full bg-black">
        <div className="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
            <div className="flex flex-row items-center justify-between pb-6">
                ...
                <button data-collapse-toggle="navbar-default" className="rounded-lg md:hidden focus:outline-none focus:shadow-outline" aria-controls="navbar-default" aria-expanded="false">
