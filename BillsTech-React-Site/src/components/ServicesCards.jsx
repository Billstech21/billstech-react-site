  ...
  return (
    ...
    {/* <!-- All-In-One Cloud Software. --> */}
		<div data-aos="flip-up" className="max-w-xl mx-auto text-center mt-24">
			...
			<p className="leading-relaxed text-gray-500">where innovation meets expertise! As a cutting-edge digital agency, we specialize in harnessing the power of technology to transform your ideas into digital reality.</p>
		</div>
		{/* <!-- card --> */}
		<div className="grid  md:grid-cols-3 gap-14 md:gap-10 mt-20">
			<div data-aos="fade-up" className="bg-white shadow-xl p-5 text-center rounded-xl">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken">Client-Centric Approach</h1>
				<p className="px-4 text-gray-500">We prioritize understanding and fulfilling our clients' unique needs and objectives.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="150" className="bg-white shadow-xl p-5 text-center rounded-xl">
				<div className="bg-[#F48C06] rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken">Innovation and Creativity</h1>
				<p className="px-4 text-gray-500">Innovation is at the heart of our solutions, ensuring our clients stay ahead in the rapidly evolving digital landscape.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="300" className="bg-white shadow-xl p-5 text-center rounded-xl">
				<div className="bg-[#29B9E7] rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14">Integrity and Transparency</h1>
				<p className="px-4 text-gray-500">We believe in honest communication and transparent practices, building trust and long-term relationships with our clients.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="300" className="bg-white shadow-xl p-5 text-center rounded-xl">
				<div className="bg-[#29B9E7] rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
					<svg className="w-6 h-6 text-white" viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14">Excellence in Execution</h1>
				<p className="px-4 text-gray-500">Our commitment to excellence is unwavering, from initial strategy to final implementation.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="300" className="bg-white shadow-xl p-5 text-center rounded-xl">
				<div className="bg-[#29B9E7] rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
					<svg className="w-6 h-6 text-white" viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14">Adaptability and Flexibility</h1>
				<p className="px-4 text-gray-500">We adapt quickly to changing market trends and client requirements, offering flexible and dynamic solutions.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="300" className="bg-white shadow-xl p-5 text-center rounded-xl">
				<div className="bg-[#29B9E7] rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
					<svg className="w-6 h-6 text-white" viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14">Collaborative Teamwork</h1>
				<p className="px-4 text-gray-500">Our team works collaboratively, leveraging diverse skills and expertise to deliver comprehensive digital solutions.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="300" className="bg-white shadow-xl p-5 text-center rounded-xl">
				<div className="bg-[#29B9E7] rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
					<svg className="w-6 h-6 text-white" viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14">Result-Oriented Strategies</h1>
				<p className="px-4 text-gray-500">We focus on delivering tangible results that drive growth and enhance ROI for our clients.</p>
			</div>
		</div>
    </div> 
    </>
